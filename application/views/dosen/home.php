        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="drop-men" >
		        <ul class=" nav_1">
					<li class="dropdown">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo $this->session->userdata('nama_dsn') ?><i class="caret"></i></span><img src="<?php echo base_url();?>assets/images/wo.jpg"></a>
		              <ul class="dropdown-menu " role="menu">
		               	<li><a href="<?php echo base_url().'Member2/signout'?>"><i class="fa fa-sign-out"></i>Keluar</a></li>
		              </ul>
		            </li>
